...
public class TasksAdapter extends RecyclerView.Adapter<TasksAdapter.TaskViewHolder> {
     ...
     */
    TasksAdapter(@NonNull final List<TaskProject> tasks, @NonNull final DeleteTaskListener deleteTaskListener) {
        this.tasks = tasks;
            ...
            imgDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (tag instanceof TaskProject) {
                        TaskViewHolder.this.deleteTaskListener.onDeleteTask((Task) ((TaskProject) tag).task);
                    }
                }
            });
        }
